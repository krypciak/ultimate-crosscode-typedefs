...
declare global {
    namespace ig {
        ...
        interface NavPath extends ig.Class {
            ...
            dodge(this: this, actor: ig.ActorEntity, minDist: number, dodgeType?: ig.NAV_DODGE_TYPE): void
            moveRange(
                this: this,
                actor: ig.ActorEntity,
                b: number,
        ...
        namespace Navigation {
            interface Influencer {
                onNavMapInfluence(this: this): void
            }
        }
        interface Navigation extends ig.GameAddon {
            influencers: ig.Navigation.Influencer[]
