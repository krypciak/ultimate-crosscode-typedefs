...
declare global {
  namespace sc {
    ...
    interface PlayerLevelTools {
      computeBaseParams(
        params: sc.CombatParams.BaseParams,
      ...
      autoequip(
        model: sc.PlayerModel | sc.PartyMemberModel,
        equipSequence: sc.PlayerConfig.AutoEquip,
        prevEquipLevel: number,
        playerLevel?: number,
        addItem?: boolean,
        ignoreConditions?: boolean,
      ): number;
      equip(
        dest: sc.PlayerModel.Equip,
