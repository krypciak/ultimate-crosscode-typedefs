...
declare global {
  namespace sc {
    ...
    interface ItemSortMenu extends sc.SortMenu {
      onButtonPress(
        this: this,
        button: sc.ButtonGui & { name: string; description: string; sortType: number },
      ): void;
    }
    interface ItemSortMenuConstructor extends ImpactClass<ItemSortMenu> {
      new (): ItemSortMenu;
    }
