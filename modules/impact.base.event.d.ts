...
declare global {
  namespace ig {
    ...
    namespace Event {
      ...
      interface Vec2ExpressionVarObject extends VarObject {}
      type Vec2Expression = Vec2 | Vec2ExpressionVarObject;

      interface Vec3ExpressionVarObject extends VarObject {}
      type Vec3Expression = (Vec2 | Vec3ExpressionVarObject) & {
        z?: number;
