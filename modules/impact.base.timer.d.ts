...
declare global {
  namespace ig {
    ...
    interface WeightTimer extends ig.Class {
      ...
      set(this: this, duration: number, mode?: ig.TIMER_MODE): void;
      getRemainingTime(this: this): number;
      setRemainingTime(this: this, time: number): void;
      tick(this: this): void;
      done(this: this): boolean;
      getTimePassed(this: this): number;
      get(this: this): number;
      getTotalWeight(this: this): number;
      hasRepeated(this: this): boolean;
      getRepeatCount(this: this): number;
      onBlinkDecline(this: this): boolean;
    }
